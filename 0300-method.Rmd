...
bcfishpass_spawn_rear_model %>% 
  ...
  fpr::fpr_kable(caption_text = 'Stream gradient and channel width thresholds used to model potentially highest value westslope cutthrout trout habitat.')
...
tab %>% 
  fpr::fpr_kable(caption_text = 'Fish Barrier Risk Assessment (MoE 2011).')
...
tab_barrier_result %>% 
  fpr::fpr_kable(caption_text = 'Fish Barrier Scoring Results (MoE 2011).') 
...
tab_cost_rd_mult_report %>%
  fpr::fpr_kable(caption_text = 'Cost multiplier table based on road class and surface type.')
```
