...
## Stream Discharge
A HACH FH950 flow meter was used to obtain high quality stream discharge measurements within both Brule and Weigert Creeks on October 18, 2023. The area-velocity method, or the current meter method, was used to determine the mean discharge using the velocity and the cross-sectional area. The hydrometric operators selected channel bed metering sections that were as uniform as possible, free from vegetation, immovable rocks, and obstructions measured, the stream depth and velocity at selected intervals across both streams were accessed by wading. The water depth and the positions across each stream width were obtained using a flow rod for depth and a survey tape for distance. A HACH FH950 flow meter was used to measure the stream velocity at each selected interval or panel. Each creek received two flow measurements, first collecting flows above each of the Highway 43 fish barriers with a second set of flows collected below each of the fish barriers. Stream flow data was collected in accordance with the Manual of British Columbia Hydrometric Standards [@risc2018ManualBritish]. This methodology was used to ensure an acceptable level of quality and accuracy. 

<br>


## Water Temperature
A HOBO Water Temp Pro v2 logger was installed approximately 20m upstream of Highway 43 on Weigert Creek and immediately below the falls at approximately 3.6km upstream of the Highway 43 culverts. Loggers on Weigert Creek were installed within a white PVC tube housing to prevent thermal transfer, with perforations on the protective housing to allow water to flow through the tubing. The loggers were anchored to the shoreline with steel cable at a water depth of 60% total depth on June 24, 2023 and pulled on November 17, 2023. Temperature was taken at 30-minute intervals for the entire length of time installed. Unfortunately, high flows with Brule Creek resulted in the dislodging of the logger installed under the falls and the subsequent loss of the logger and all associated data.
<br>
