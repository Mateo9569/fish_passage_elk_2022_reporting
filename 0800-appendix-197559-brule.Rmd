...
The stream was surveyed at two different sites upstream of crossing `r as.character(my_site)`. The first site was located approximately 1km from the culvert. This section was surveyed for `r fpr::fpr_my_priority_info(loc = 'us_ef1', col_pull = 'length_surveyed')`m (Figure \@ref(fig:photo-197559-01)). The second site was located approximately 1km upstream of modelled crossing 197536. This section was surveyed for `r fpr::fpr_my_priority_info(loc = 'us_ef2', col_pull = 'length_surveyed')`m to the location of a waterfall (Figure \@ref(fig:photo-197559-04)). This waterfall was approximately 5m in height, and blocks the upstream migration of all fish. This obstacle is listed in the Canadian Aquatic Barrier Database and the BC Provincial Obstacles to Fish Passage catalogue.  [@canadianwildlifefederation2023CanadianAquatic; @bcgovernment2023ProvincialObstacles]. Stream habitat quality is shown in Figures \@ref(fig:photo-197559-02) - \@ref(fig:photo-197559-03).  
